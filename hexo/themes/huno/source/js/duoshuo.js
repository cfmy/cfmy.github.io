...
function sskadmin(e) {
	var ssk = '';
	if (e.user_id == 6221277831146504961) {
		ssk = '<span style="background:red"><i class="user-root"></i> root '
	}
	return ssk;
}
//管理员判断结束
...
! function(e, t, s) {
	...
	if (o.extend = function(e, t) {
		...
		S.DOMAIN = "duoshuo.com", S.STATIC_URL = g + "//static.duoshuo.com", S.REMOTE = g + "//duoshuo.com", S.version = "16.2.24";
		var A = {
				"default": "349d9313",
				dark: "b9ab6243",
				bluebox: "17249850",
		...
		it.on("queryDefined", function() {
			...
			function T(e) {
				...
				B("#ds-notify").hide(), R.get(t.apiUrl, {}, function(e) {
			...
			function U(e, t) {
				...
				function d() {
					...
					return i[0] ? (i.remove(), !1) : (i = B('<ul class="ds-children"></ul>').insertAfter(s), R.get("posts/listComments", H({
						post_id: a
					}), e), !1)
				}
					...
					function t() {
						...
						try {
							if (a.hasClass("ds-comment-context")) K.attr("id", "ds-ctx-bubble").attr("data-post-id", a.attr("data-post-id")).html('<ul id="ds-ctx">' + et.ctxPost({
								...
								if (!c) throw "no info";
								K.attr("id", "ds-user-card").attr("data-user-id", c).empty(), ct[c] ? K.html(et.userInfo(ct[c].data)) : R.get("users/profile", H(l), t)
							}
							X.css({
								bottom: o,
								left: d
			...
			e.postMessage && (e.addEventListener ? e.addEventListener("message", g, !1) : e.attachEvent && e.attachEvent("onmessage", g)), S.scrollTo = function(e) {
				...
				render: function(e) {
					...
					var q = function(e) {
						s(b), R.post("posts/create", B.extend(S.toJSON(b), e), function(e) {
			...
			X.mouseenter(N).mouseleave(I), st.PostList = function(e) {
				...
				uri: "base/recommend",
				mountedSelectorLists: [".detail_main .detail_con .d_img p:last", ".jun4_article .jun4_cententttt"],
				_init: function() {
				...
				mount: function(e) {
					var t = B(this.mountedSelectorLists.join(","));
					if (t.length) try {
					...
					! function t() {
						clearTimeout(e._count_timer), e.el.find(".ds-reads-date").each(function() {
							var e, t, s, a, i, r, n = B(this).data("date"),
								...
								d = o - n,
								l = new Date(n);
							d > 864e5 ? (e = l.getFullYear(), t = l.getMonth() + 1, s = l.getDate(), B(this).html(e + "年" + t + "月" + s + "日")) : d > 36e5 ? (a = Math.floor(d / 60 / 60 / 1e3), B(this).html(a + "小时前")) : d > 6e4 ? (i = Math.floor(d / 60 / 1e3), B(this).html(i + "分钟前")) : (r = Math.floor(d / 1e3), B(this).html(r + "秒前"))
				...
				onload: function(t) {
					...
					a.model = new Y(a.data = t.thread), lt.set(t.parentPosts || t.relatedPosts), ct.set(t.users), a.el.find("#ds-waiting").remove(), t.options && t.options.show_recommend && (a.relatedRead = new st.RelatedRead, a.relatedRead.load(t.thread.thread_id), a.relatedRead.mount(d)), o.like_thread_enabled && (a.meta = new st.Meta(a), d.append(a.meta.render().el)), o.hot_posts && t.hotPosts && t.hotPosts.length && (a.hotPosts = new st.HotPosts(B('<div class="ds-rounded"></div>'), {
						max_depth: 1,
			...
			S.initSelector = function(e, t) {
				...
				!q() || !B.isReady && j || B(e).each(function(e, s) {
					...
					if (!i.data("initialized")) {
						...
						if (at.push(r), "ThreadCount" === t.type) {
							...
							}), R.get(r.uri, H(o), function(e) {
								r.load(e)
							})
						}
					}
				}), a.length && R.get("threads/counts", H({
					threads: a.join(",")
				}), s)
			}, (S.initView = function() {
				...
				}, 2e4), c.ondomready && c.ondomready(), S.initView(), !it && c.short_name && R.get("analytics/ping", H({}), W)
			})
		})
	}
}(window, document);